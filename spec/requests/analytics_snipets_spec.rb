...
describe "analytics code snipets" do
  describe "gauge" do
    it "generate gauge snippet if site exists" do
      Monologue2::Config.gauge_analytics_site_id = "gauge id here"
      visit root_path
    ...
    it "does not generate gauge snippet if no site id has been set" do
      Monologue2::Config.gauge_analytics_site_id = nil
      visit root_path
